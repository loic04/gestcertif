...
<html class="no-js">
    <head>
        <title>GESTCERTIF</title>
		<meta name="description" content="Gestion de certificat">
		<meta name="author" content="Loïc Angora/Kesse brice">
		<meta charset="iso-8859-1">
        <!-- Bootstrap -->
				<link href="admin/images/logo1_petit.gif" rel="icon" type="image">
