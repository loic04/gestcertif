...
function Header()
{
    ...
    $this->Cell(0,6,'LISTE DES UTILISATEURS',0,1,'C');
    $this->Ln(10);
    //Imprime l'en-tête du tableau si nécessaire
    parent::Header();
}
...
$pdf->AddCol('EMP_PRENOM',40,'Prénoms');
$pdf->AddCol('EMP_PHONE',30,'Phone');
$pdf->AddCol('EMP_MAIL',60,'Email');
$pdf->AddCol('EMP_DROIT',30,'Statut');
$prop=array('HeaderColor'=>array(1,254,248),
            'color1'=>array(255,255,255),
            'color2'=>array(255,255,255),
            'padding'=>1);
$pdf->Table('SELECT * FROM employe	order by EMP_ID',$prop);
$pdf->Output();
?> 