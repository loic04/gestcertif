<div class="span3" id="sidebar">
	...
	<li class=""><a href="dasboard_employe.php"><i class="icon-chevron-right"></i><i class="icon-home"></i>&nbsp;Accueil</a></li>
	   ...
	   <li ><a href="clients.php"><i class="icon-chevron-right"></i><i class="icon-ok"></i>&nbsp;Clients</a></li> 
	   <li class="active"><a href="certificats.php"><i class="icon-chevron-right"></i><i class="icon-file"></i>&nbsp;Certificats</a></li> 
