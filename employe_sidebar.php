<div class="span3" id="sidebar">
	...
	<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
	   <li class="active"><a href="dasboard_employe.php"><i class="icon-chevron-right"></i><i class="icon-home"></i>&nbsp;Accueil</a></li>
	   <li class=""><a href="employes.php"><i class="icon-chevron-right"></i><i class="icon-user-md"></i>&nbsp;Utilisateurs</a></li>
	   <li class=""><a href="clients.php"><i class="icon-chevron-right"></i><i class="icon-ok"></i>&nbsp;Clients</a></li>
	   <li class=""><a href="certificats.php"><i class="icon-chevron-right"></i><i class="icon-file"></i>&nbsp;Certificats</a></li>
